...
El disco duro se considera un periférico de E/S (Entrada/Saida)
...
En lenguajes interpretados no existe codigo objeto, ni binario. Solo codigo fuente. Por ejemplo PHP, Java scrtipt.
...
- **La especificación de requisitos** debe:
  ...
  - Evitar ambigüedades. Utilizar un lenguaje formal.
...
Validar: Se esta haciendo el producto correcto. De los clientes
Verificar: Se esta hacientdo el producto correctamente. De la empresa
